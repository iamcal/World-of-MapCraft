<?
	...
	$add_labels = 1;
	build_wmo_map('cataclysm/stvdiamondmine', 'stv_diamond_mine_bg');
	build_wmo_map('test', 'mbuilding05');
	build_wmo_map('test', 'qatestwmo1');
	build_wmo_map('dungeon/easttemple', 'pa_easttemple');
	build_wmo_map('dungeon/easttemple', 'pa_easttemple_instance');
	build_wmo_map('dungeon/easttemple', 'pa_easttemple_lod1');
	build_wmo_map('dungeon/ghostbrewery', 'pa_ghostbrewery');
	build_wmo_map('dungeon/ghostbrewery', 'pa_ghostbrewery_ext');
	build_wmo_map('dungeon/ghostbrewery', 'pa_ghostbrewery_ext_lod1');
	build_wmo_map('dungeon/greatwall', 'pa_greatwall');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_c');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_d');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_01');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_01_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_02');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_02_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_03');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_03_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_04');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_04_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_05');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_05_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_06');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_06_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_07');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_northspan_07_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_01');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_01_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_02');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_02_ext');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_05');
	build_wmo_map('dungeon/greatwall/section', 'pa_greatwall_southspan_05_ext');
	build_wmo_map('dungeon/greatwall/tower', 'pa_greatwall_tower01');
	build_wmo_map('dungeon/mantiddungeon', 'pa_mantiddungeon_instance');
	build_wmo_map('dungeon/mantiddungeon', 'pa_mantiddungeon_tree');
	build_wmo_map('dungeon/mantidraid', 'pa_mantid_raid');
	build_wmo_map('dungeon/mantidraid', 'pa_mantid_raid_exterior');
	build_wmo_map('dungeon/royalquarters', 'pa_royalquarters');
	build_wmo_map('dungeon/shadowpanhideout', 'pa_shadowpan_combat');
	build_wmo_map('dungeon/shadowpanhideout', 'pa_shadowpan_master');
	build_wmo_map('dungeon/shadowpanhideout', 'pa_shadowpan_student');
	build_wmo_map('dungeon/shadowpanhideout', 'pa_shadowpan_student_ext');
	build_wmo_map('dungeon/thedepths', 'pa_moguraid');
	build_wmo_map('dungeon/thedepths', 'pa_moguraid_ext');
	build_wmo_map('pandaria/cliffs', 'pa_cliffsofdespair_01');
	build_wmo_map('pandaria/generic/dojo', 'pa_dojo');
	build_wmo_map('pandaria/generic/dojo', 'pa_dojo_lod1');
	build_wmo_map('pandaria/generic/dragon_tunnel', 'pa_dragon_tunnel');
	build_wmo_map('pandaria/generic/dragon_tunnel', 'pa_dragon_tunnel_01');
	build_wmo_map('pandaria/generic/fireworks', 'pa_fireworks');
	build_wmo_map('pandaria/generic/gazebo', 'pa_bell_gazebo_01');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse01');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse01_lod1');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse01_snow');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse02');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse02_lod1');
	build_wmo_map('pandaria/generic/house', 'pa_countryhouse02_snow');
	build_wmo_map('pandaria/generic/house', 'pa_countryinn01');
	build_wmo_map('pandaria/generic/house', 'pa_house01');
	build_wmo_map('pandaria/generic/house', 'pa_house01_lod1');
	build_wmo_map('pandaria/generic/house', 'pa_house02');
	build_wmo_map('pandaria/generic/house', 'pa_house02_lod1');
	build_wmo_map('pandaria/generic/inn', 'pa_inn');
	build_wmo_map('pandaria/generic/inn', 'pa_inn_lod1');
	build_wmo_map('pandaria/generic/monastery', 'pa_monastery');
	build_wmo_map('pandaria/generic/monastery', 'pa_monastery_lod1');
	build_wmo_map('pandaria/generic/pools_of_sight', 'pa_pools_of_sight');
	build_wmo_map('pandaria/generic/pools_of_sight', 'pa_pools_of_sight_01');
	build_wmo_map('pandaria/generic/pools_of_sight', 'pa_pools_of_sight_02');
	build_wmo_map('pandaria/generic/pools_of_sight', 'pa_pools_of_sight_a');
	build_wmo_map('pandaria/generic/rural_house', 'pa_pumpkinpatch_crop01');
	build_wmo_map('pandaria/generic/rural_house', 'pa_pumpkinpatch_crop02');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_barn2');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_fishinghut01');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_fishinghut01_lod1');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_house01');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_house01_lod1');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_house02');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_house02_lod1');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_house03');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_inn');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_inn_lod1');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_silo_02');
	build_wmo_map('pandaria/generic/rural_house', 'pa_rural_silo_02_lod1');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_pristine');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_pristine_a');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_pristine_b');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_pristine_c');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_pristine_d');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_snow');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave01_snow_a');
	build_wmo_map('pandaria/generic/small_cave', 'pa_small_cave02');
	build_wmo_map('pandaria/generic/spanning_stone_bridge', 'pa_spanning_stone_bridge01');
	build_wmo_map('pandaria/generic/spanning_stone_bridge', 'pa_spanning_stone_bridge01_lod1');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro01');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro01_lod1');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro02');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro02_lod1');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro03');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro03_lod1');
	build_wmo_map('pandaria/generic/stairs', 'pa_verming_underground_micro_lod1');
	build_wmo_map('pandaria/generic/stonewatchtower', 'pa_stonewatchtower_open');
	build_wmo_map('pandaria/generic/stonewatchtower', 'pa_stonewatchtower_open_lod1');
	build_wmo_map('pandaria/generic/temple', 'pa_temple01');
	build_wmo_map('pandaria/generic/temple', 'pa_temple01_lod1');
	build_wmo_map('pandaria/generic/tunnel', 'pa_tunnel01');
	build_wmo_map('pandaria/mantid', 'pa_egg_chamber01');
	build_wmo_map('pandaria/mantid', 'pa_egg_chamber02');
	build_wmo_map('pandaria/mantid', 'pa_egg_chamber03');
	build_wmo_map('pandaria/mogu', 'pa_ancientmogu_building');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt01');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt02');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt03');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt04');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt05');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt06');
	build_wmo_map('pandaria/mogu', 'pa_mogu_crypt07');
	build_wmo_map('pandaria/mogu', 'pa_moguruins_4');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_a');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_b');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_c');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_c_lod1');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_d');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_e');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_e_lod1');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_l');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_l_lod1');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_m');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_p');
	build_wmo_map('pandaria/townlongwastes/gianttree', 'mz_gianttree_group_p_lod1');
	build_wmo_map('pandaria/townlongwastes/westtemple', 'pa_westerntemple');
	build_wmo_map('pandaria/townlongwastes/westtemple', 'pa_westerntemple_bridge1');
	build_wmo_map('pandaria/townlongwastes/westtemple', 'pa_westerntemple_bridge2');
	build_wmo_map('pandaria/turtlezone/burial_chamber', 'pa_burial_chamber');
	build_wmo_map('pandaria/turtlezone/jademine', 'pa_jade_mine');
	build_wmo_map('pandaria/valeofeternalblossoms/mogu', 'mg_northgate');
	build_wmo_map('pandaria/valeofeternalblossoms/mogu', 'mg_northgateb');
	build_wmo_map('pandaria/valeofeternalblossoms/mogu', 'mg_northgateb_lod1');
	build_wmo_map('pandaria/valeofeternalblossoms/mogu', 'mg_northgatec');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_raidbuilding_ld');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_raidbuilding_ld_lod1');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_raidentrance');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_raidentrance_lod1');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_templehub_ld');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_templehub_ld_horde');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_templehub_ld_horde_lod1');
	build_wmo_map('pandaria/valeofeternalblossoms/temples', 'mg_templehub_ld_lod1');
	build_wmo_map('pandaria/valleyoffourwinds/northtemple', 'pa_northerntemple_1door_building');
	build_wmo_map('pandaria/valleyoffourwinds/northtemple', 'pa_northerntemple_arena');
	build_wmo_map('pandaria/valleyoffourwinds/northtemple', 'pa_northerntemple_building');
	build_wmo_map('pandaria/valleyoffourwinds/southtemple', 'pa_southerntemple');
	exit;
